<div class="flex flex-col w-[300px] mx-auto py-16">
    <div class="flex justify-between gap-4">
        ...
        <button
            wire:click="addTodo"
            class="px-4 py-2 text-white bg-indigo-500 rounded hover:bg-indigo-600 disabled:cursor-not-allowed disabled:bg-opacity-90"
        >เพิ่ม</button>
    </div>

    <div class="py-6">
        @if (count($todos) == 0)
            <p class="text-center text-gray-500">ไม่มีสิ่งที่ต้องทำ</p>
        @endif
